...
(function ($, undefined) {
    ...
    AbstractSelect2 = clazz(Object, {
        ...
        opening: function() {
            ...
            var searchDiv = this.search.parent(),
                searchDivWidth = searchDiv.width();

            if($.browser.msie === true && $.browser.version === '7.0') {
                searchDiv.width(searchDiv.parent().width() - (searchDiv.outerWidth(true) - searchDivWidth));
                this.search.width(searchDiv.width() - (this.search.outerWidth(true)-this.search.width()));
            }
