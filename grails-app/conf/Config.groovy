...
uiperformance.bundles = [
    [
        ...
        files: [
            '../legacy/js-lib/dojo-1.5.0-windowname-only/dojo/owfdojo.js.uncompressed',
            '../legacy/js/audit/Audit',
            '../legacy/js/util/pageload',
            '../legacy/js/util/version',
            '../legacy/js/util/util',
            '../legacy/js/util/guid',
            '../legacy/js/components/keys/HotKeys',
            '../legacy/js/components/keys/KeyEventSender',
            '../legacy/js/lang/ozone-lang',
            '../legacy/js/lang/DateJs/globalization/en-US',
            '../legacy/js/util/transport',
            '../legacy/js/util/widget_utils',
            '../legacy/js/../js-lib/shindig/util',
            '../legacy/js/../js-lib/shindig/json',
            '../legacy/js/../js-lib/shindig/rpc',
            '../legacy/js/../js-lib/shindig/pubsub',
            '../legacy/js/../js-lib/log4javascript/log4javascript',
            '../legacy/js/util/log',
            '../legacy/js/pref/preference',
            '../legacy/js/eventing/Widget',
            '../legacy/js/intents/WidgetIntents',
            '../legacy/js/chrome/WidgetChrome',
            '../legacy/js/dd/WidgetDragAndDrop',
            '../legacy/js/launcher/WidgetLauncher',
            '../legacy/js/state/WidgetStateHandler',
            '../legacy/js/state/WidgetState',
            '../legacy/js/eventing/WidgetProxy',
            '../legacy/js/kernel/kernel-client',
            '../legacy/js/metrics/BaseMetrics',
            '../legacy/js/widget/Widget',
            '../legacy/js/widget/widgetInit'
        ]
    ],
    [
        type: 'js',
